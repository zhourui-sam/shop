<template>
  <div>
    ...
    <div class='shopping'>
      ...
      <div v-if="this.flag===0">  <van-submit-bar :price="total*100" button-text="提交订单1" @submit="onSubmit1" /></div>
    <div v-else>  <van-submit-bar :price="total*100" button-text="提交订单" @submit="onSubmit" /></div>
    </div>
  </div>
</template>
