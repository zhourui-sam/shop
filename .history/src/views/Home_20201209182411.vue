<template>
  <div class='bg'>
    ...
    <div class='main'>
      ...
      <firstfloor :floor2='floor2' :floorname2='floorname2' v-if='floor2.length>0'></firstfloor>
      <firstfloor :floor3='floor3' :floorname3='floorname3' v-if='floor3.length>0'></firstfloor>
    </div>
  </div>
</template>
