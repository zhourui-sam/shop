<template>
  <div class='bg'>
    ...
    <div class='main'>
      ...
      <firstfloor :floor1='floor1' :floorname1='floorname1' v-if='floor1.length>0' class='Floor'></firstfloor>
      <firstfloor :floor1='floor2' :floorname1='floorname2' v-if='floor2.length>0' class='Floor'></firstfloor>
      <firstfloor :floor1='floor3' :floorname1='floorname3' v-if='floor3.length>0' class='Floor'></firstfloor>
    </div>
  </div>
</template>
