<template>
  <div>
    ...
    <div class='account'>
      <div class="checkall">
        <van-checkbox v-model="checked" shape="square" checked-color="#ee0a24" class='allcheck'>
      ...
      <van-button type="warning" class='btn'>删除</van-button>
      <van-button type="warning" class='btn tobuy'>去结算</van-button>
    </div>
    <div class='cars'>
