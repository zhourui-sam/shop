<template>
  <div class='bg'>
    ...
    <div class='main'>
      ...
      <hotGoods :hotGoods='hotGoods' style='margin-bottom:20px;' v-if='hotGoods.length>0'></hotGoods>
    </div>
  </div>
</template>
...
export default {
  ...
  components: {navHeader,rotate,category,advertesPicture,firstfloor,hotGoods},
  methods: {},
  mounted() {
