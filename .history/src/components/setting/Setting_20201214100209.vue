  ...
  <div>
    ...
    <div class='main'>
      <van-cell-group>
        ...
        <van-field lable="用户名" v-model="this.information.username"/>
        <van-field lable="昵称" v-model="this.information.nickname"/>
        <van-field lable="性别" v-model="this.information.gender"/>
        <van-field lable="邮箱" v-model="this.email" placeholder="请输入邮箱"/>
        <van-field lable="出生年月日" v-model="this.birthdate"/>
      </van-cell-group>
    </div>
  </div>
</template>
